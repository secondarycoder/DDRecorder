...
def write_ass(ass_start: int, ass_end: int, user: str, price: int, sctext: str):
    ...
    if price >= 1000:
        t1 = '{\move(-100,' + h1 + ',0,' + h1 + ')\c&HE5E5FF\shad0\p1}'
        t6 = '{\pos(0,' + h1 + ')\clip(m 0 17 b 10 8 18 0 27 0 l 493 0 b 502 0 510 8 510 17 l 510 1080 l 10 1080)\c&HE5E5FF\shad0\p1}'
        t2 = '{\move(-100,' + h2 + ',0,' + h2 + ')\shad0\p1\c&H8C8CF7}'
        t7 = '{\pos(0,' + h2 + ')\clip(m 0 17 b 10 8 18 0 27 0 l 493 0 b 502 0 510 8 510 17 l 510 1080 l 10 1080)\shad0\p1\c&H8C8CF7}'
        t3 = '{\move(-92,' + h3 + ',8,' + h3 + ')\c&H0F0F75\\fs35\\b1\q2}'
        t8 = '{\pos(8,' + h3 + ')\clip(m 0 17 b 10 8 18 0 27 0 l 493 0 b 502 0 510 8 510 17 l 510 1080 l 10 1080)\c&H0F0F75\\fs35\\b1\q2}'
    elif price >= 500:
        t1 = '{\move(-100,' + h1 + ',0,' + h1 + ')\c&HD4F6FF\shad0\p1}'
        t6 = '{\pos(0,' + h1 + ')\clip(m 0 17 b 10 8 18 0 27 0 l 493 0 b 502 0 510 8 510 17 l 510 1080 l 10 1080)\c&HD4F6FF\shad0\p1}'
        t2 = '{\move(-100,' + h2 + ',0,' + h2 + ')\shad0\p1\c&H8CCEF7}'
        t7 = '{\pos(0,' + h2 + ')\clip(m 0 17 b 10 8 18 0 27 0 l 493 0 b 502 0 510 8 510 17 l 510 1080 l 10 1080)\shad0\p1\c&H8CCEF7}'
        t3 = '{\move(-92,' + h3 + ',8,' + h3 + ')\c&H236C64\\fs35\\b1\q2}'
        t8 = '{\pos(8,' + h3 + ')\clip(m 0 17 b 10 8 18 0 27 0 l 493 0 b 502 0 510 8 510 17 l 510 1080 l 10 1080)\c&H236C64\\fs35\\b1\q2}'
    elif price >= 100:
        t1 = '{\move(-100,' + h1 + ',0,' + h1 + ')\c&HCAF9F8\shad0\p1}'
        t6 = '{\pos(0,' + h1 + ')\clip(m 0 17 b 10 8 18 0 27 0 l 493 0 b 502 0 510 8 510 17 l 510 1080 l 10 1080)\c&HCAF9F8\shad0\p1}'
        t2 = '{\move(-100,' + h2 + ',0,' + h2 + ')\shad0\p1\c&H76E8E9}'
        t7 = '{\pos(0,' + h2 + ')\clip(m 0 17 b 10 8 18 0 27 0 l 493 0 b 502 0 510 8 510 17 l 510 1080 l 10 1080)\shad0\p1\c&H76E8E9}'
        t3 = '{\move(-92,' + h3 + ',8,' + h3 + ')\c&H1A8B87\\fs35\\b1\q2}'
        t8 = '{\pos(8,' + h3 + ')\clip(m 0 17 b 10 8 18 0 27 0 l 493 0 b 502 0 510 8 510 17 l 510 1080 l 10 1080)\c&H1A8B87\\fs35\\b1\q2}'
    else:
        t1 = '{\move(-100,' + h1 + ',0,' + h1 + ')\c&HFCE8D8\shad0\p1}'
        t6 = '{\pos(0,' + h1 + ')\clip(m 0 17 b 10 8 18 0 27 0 l 493 0 b 502 0 510 8 510 17 l 510 1080 l 10 1080)\c&HFCE8D8\shad0\p1}'
        t2 = '{\move(-100,' + h2 + ',0,' + h2 + ')\shad0\p1\c&HE4A47A}'
        t7 = '{\pos(0,' + h2 + ')\clip(m 0 17 b 10 8 18 0 27 0 l 493 0 b 502 0 510 8 510 17 l 510 1080 l 10 1080)\shad0\p1\c&HE4A47A}'
        t3 = '{\move(-92,' + h3 + ',8,' + h3 + ')\c&H8A3619\\fs35\\b1\q2}'
        t8 = '{\pos(8,' + h3 + ')\clip(m 0 17 b 10 8 18 0 27 0 l 493 0 b 502 0 510 8 510 17 l 510 1080 l 10 1080)\c&H8A3619\\fs35\\b1\q2}'
    t4 = '{\move(-92,' + h4 + ',8,' + h4 + ')\c&H313131\\fs28\q2}'
    t5 = '{\move(-92,' + h2 + ',8,' + h2 + ')\c&HFFFFFF\q2}'
    t9 = '{\pos(8,' + h4 + ')\clip(m 0 17 b 10 8 18 0 27 0 l 493 0 b 502 0 510 8 510 17 l 510 1080 l 10 1080)\c&H313131\\fs28\q2}'
    t10 = '{\pos(8,' + h2 + ')\clip(m 0 17 b 10 8 18 0 27 0 l 493 0 b 502 0 510 8 510 17 l 510 1080 l 10 1080)\c&HFFFFFF\q2}'
